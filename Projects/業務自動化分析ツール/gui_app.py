...
class ActivityLoggerUI:
    ...
    def generate_report(self):
        ...
        try:
            ...
            # 1. HTML日報とAI評価済みCSVの生成
            generate_daily_report.generate_reports(target_dir=target_dir)
            # 2. Excelの図解レポートの生成
            generate_visual_excel_report.create_visual_report(log_dir=target_dir)
            
            messagebox.showinfo("完了", "日報（HTML）およびExcel図解レポートを出力しました！\n出力先フォルダをご確認ください。")
